...
public class Critter
{
    ...
    public Critter(String newDNA, int xPos, int yPos, String facing)
    {
        length = newDNA.length();
        body = new Point[length];
        dna = new String[length];
    ...
    public void move(Point nextPoint)
    {
        ...
        /* if (facing.equals("U"))
        {
            if (lastY == 0)
            {
                body[0].move(lastX, boardSize-1);
            }
            else
            {
                body[0].move(lastX, (lastY - 1));
            }
        }
